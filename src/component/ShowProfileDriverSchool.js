...
const ShowProfileDriverSchool = ({ data, vehicle, status }) => {
                          ...
                          try {
                            if (driverId.id) {
                              const dataStatus = ref(
                                db,
                                `POSTED_RIDES_TO_SCHOOL/${driverId.id}/rideInfo/vehicle/`
                              );
                              ...
                              const requestDocRef = ref(
                                db,
                                `POSTED_RIDES_TO_SCHOOL/${driverId.id}/request/${data.userInfo.accID}`
                              );
...
export default ShowProfileDriverSchool;
